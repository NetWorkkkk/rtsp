...
Add a screenshot showing the RTSP server running and listening for client connections.

![Server startup demo](images/demo-01-server-startup.png)

### 6.2 Client Setup and Playback

Add a screenshot showing the client GUI after `SETUP` and `PLAY`, with the video being rendered successfully.

![Client playback demo](images/demo-02-client-playback.png)

### 6.3 SD Streaming over UDP

Add a screenshot or diagram showing SD mode, where the frame is split into UDP/RTP tiles and reconstructed on the client side.

![SD UDP streaming demo](images/demo-03-sd-udp-streaming.png)

### 6.4 HD Streaming over TCP

Add a screenshot showing HD mode, where full MJPEG frames are transported over the TCP media path.

![HD TCP streaming demo](images/demo-04-hd-tcp-streaming.png)

### 6.5 SD/HD Switching and Buffering
...
![SD HD switching demo](images/demo-05-sd-hd-switching.png)
